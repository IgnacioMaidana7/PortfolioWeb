        ...
        >
            ...
            >
                ...
                <motion.h3
                    ...
                    transition={springTransition}
                    className="text-xl md:text-2xl font-bold text-slate-900 dark:text-slate-50 mb-3 group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors"
                >
                    {project.title}
                </motion.h3>
